...
export default function Checkout() {
  ...
  return (
    <div>
      <Header />
      <div className="checkout-container min-h-screen bg-gradient-to-br from-sky-100 to-sky-200 p-8 flex justify-center items-start">
              ...
              cartDetails.map((item) => (
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-sm text-sky-500">Size: {item.size}</p>
