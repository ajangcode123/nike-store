    ...
    <div className="text-center">
      ...
      >
        <div className="bg-black bg-opacity-50 p-6 rounded-md text-white">
          <h1 className="text-5xl font-bold mb-4 proquest-guerrilla-regular">Discover the Latest Collection</h1>
          <p className="text-lg proquest-guerrilla-regular">Step into comfort and style with our new arrivals.</p>
        </div>
      </div>
      ...
      <div className="mt-16 py-10 bg-gradient-to-r from-sky-300 to-sky-500 text-white">
        <h2 className="text-4xl font-bold mb-4">Exclusive Offer!</h2>
        <p className="text-lg">Sign up now and get 20% off your first purchase!</p>
        <Link to={"/products"}><button className="mt-6 bg-white text-blue-500 font-semibold py-2 px-4 rounded-lg hover:bg-blue-100 transition-colors duration-300">
          Shop Now
        </button>
        </Link>
      </div>
