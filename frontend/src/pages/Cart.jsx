  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-sky-300 via-sky-100 to-sky-300 p-8 flex justify-center">
        ...
        {/* Summary */}
        <div className="w-96 bg-white shadow-2xl rounded-2xl p-8">
          <h3 className="text-3xl font-semibold text-gray-800 mb-6">Summary</h3>
          <div className="flex justify-between text-gray-700 text-lg mb-4">
            <p>Subtotal:</p>
            <p>${calculateTotal().toFixed(2)}</p>
          </div>
          <div className="flex justify-between text-gray-700 text-lg mb-6">
            <p>Total:</p>
            <p className="font-semibold">${calculateTotal().toFixed(2)}</p>
          </div>
          <button
            onClick={handleCheckout}
            className="w-full bg-gradient-to-r from-sky-600 to-sky-700 text-white py-3 rounded-lg shadow-md hover:shadow-lg hover:from-sky-700 hover:to-sky-800 transition-all duration-300"
          >
            Proceed to Checkout
          </button>
        </div>
