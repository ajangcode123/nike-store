            ...
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full">
              ...
              <div className="flex justify-end space-x-2">
                <button
                  ...
                  className="bg-green-500 text-white px-4 py-2 rounded-md shadow hover:bg-green-600 transition-all duration-300"
                >
                  Add to Cart
                </button>
                ...
                <button
                  ...
                  className="bg-red-500 text-white px-4 py-2 rounded-md shadow hover:bg-red-600 transition-all duration-300"
                >
                  Cancel
                </button>
              </div>
